...
public class Busqueda extends JFrame {
	...
	public Busqueda() {
		...
		txtBuscar.setBackground(new Color(192, 192, 192));
		...
		lblTitulo.setBounds(287, 61, 344, 42);
		...
		tbHuespedes.setBackground(new Color(192, 192, 192));
		...
		tbReservas.setBackground(new Color(192, 192, 192));
		...
		lblBuscar.setBackground(new Color(0, 0, 51));
		...
		lblBuscar.setForeground(new Color(192, 192, 192));
		...
		lblEditar.setBackground(new Color(0, 0, 51));
		lblEditar.setHorizontalAlignment(SwingConstants.CENTER);
		lblEditar.setForeground(new Color(192, 192, 192));
		...
		lblEliminar.setForeground(new Color(192, 192, 192));
