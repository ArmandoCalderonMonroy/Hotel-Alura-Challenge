...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		lblValor.setForeground(new Color(0, 0, 128));
		...
		lblTitulo.setBounds(86, 60, 248, 42);
		lblTitulo.setForeground(new Color(0, 0, 128));
		lblTitulo.setFont(new Font("Roboto", Font.BOLD, 20));
		panel.add(lblTitulo);

		JPanel fondoImagen = new JPanel();
		fondoImagen.setBounds(428, 36, 482, 524);
		fondoImagen.setBackground(new Color(0, 0, 0));
		...
		btnAtras.setBackground(new Color(128, 128, 128));
		...
		lblSiguiente.setBackground(new Color(192, 192, 192));
		lblSiguiente.setHorizontalAlignment(SwingConstants.CENTER);
		lblSiguiente.setForeground(new Color(192, 192, 192));
		...
		txtValor.setBounds(68, 327, 289, 33);
		...
		btnsiguiente.setBackground(new Color(0, 0, 51));
