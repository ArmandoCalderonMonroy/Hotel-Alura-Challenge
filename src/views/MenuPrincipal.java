...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		JLabel lblCopyR = new JLabel("Desarrollado por Armando Calderon © 2023");
		lblCopyR.setBounds(300, 10, 315, 19);
		...
		labelExit.setBackground(new Color(192, 192, 192));
		...
		btnLogin.setBounds(719, 307, 83, 70);
		...
		lblTitulo.setBounds(719, 260, 83, 24);
