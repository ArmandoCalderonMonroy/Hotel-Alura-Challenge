...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(int idReserva) {
		...
		lblApellido.setBounds(560, 180, 255, 14);
		...
		lblNacimiento.setForeground(new Color(0, 0, 128));
		...
		btnguardar.setBackground(new Color(0, 0, 51));
		contentPane.add(btnguardar);
		btnguardar.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
		
		JLabel labelGuardar = new JLabel("GUARDAR");
		labelGuardar.setHorizontalAlignment(SwingConstants.CENTER);
		labelGuardar.setForeground(new Color(192, 192, 192));
		labelGuardar.setFont(new Font("Roboto", Font.PLAIN, 18));
		labelGuardar.setBounds(0, 0, 122, 35);
		btnguardar.add(labelGuardar);
		
		JPanel panel = new JPanel();
		panel.setBounds(0, 35, 489, 599);
		...
		labelExit.setForeground(new Color(192, 192, 192));
		...
		labelAtras.setForeground(new Color(192, 192, 192));
