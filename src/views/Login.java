...
public class Login extends JFrame {
	...
	public Login() {
		...
		panel_1.setBounds(484, 35, 304, 492);
		panel.add(panel_1);
		panel_1.setLayout(null);
		
		JLabel imgHotel = new JLabel("");
		imgHotel.setBounds(0, 10, 304, 365);
		panel_1.add(imgHotel);
		imgHotel.setBackground(new Color(0, 0, 0));
		...
		labelTitulo.setForeground(new Color(0, 0, 128));
		labelTitulo.setFont(new Font("Roboto Black", Font.PLAIN, 26));
		labelTitulo.setBounds(65, 149, 258, 26);
		...
		LabelUsuario.setForeground(new Color(0, 0, 128));
		...
		labelExit.setBounds(735, 0, 53, 36);
